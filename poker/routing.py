...
websocket_urlpatterns = [
    re_path(r'wss/chat/(?P<room_name>\w+)/(?P<username>\w+)/$', consumers.ChatConsumer),
    re_path(r'wss/poker/(?P<room_name>\w+)/newUserConnected/(?P<username>\w+)/$', consumers.NewPlayerConsumer),
    re_path(r'wss/poker/(?P<room_name>\w+)/playerDecision/(?P<username>\w+)/$', consumers.PlayerDecisionConsumer),
